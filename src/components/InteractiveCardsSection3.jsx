...
import "../styles/InteractiveCards3.css";

const InteractiveCardsSection3 = () => {
  const [openCard, setOpenCard] = useState(null);

  const cards = [
    {
      id: 1,
      title: " قطعات آلومینایی",
      subtitle: "",
      image: "/img2/alominai.png",
      code: "PZCSH1-s",
    },
    {
      id: 2,
      title: " قطعات زیرکونیایی",
      subtitle: " ",
      image: "/img2/zirkono.png",
      code: "PZCSH2-s",
    },
    {
      id: 3,
...
export default InteractiveCardsSection3;
