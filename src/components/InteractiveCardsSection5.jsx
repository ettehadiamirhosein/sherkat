...
import "../styles/InteractiveCards5.css";

const InteractiveCardsSection5 = () => {
  const [openCard, setOpenCard] = useState(null);

  const cards = [
    {
      id: 1,
      title: " اسلیو های ریخته گری ",
      subtitle: "سایزهای مختلف",
      image: "/img2/slive.png",
      code: "ُSPZ1-s",
    },
    // {
    //   id: 2,
    ...
    <section className="interactive-cards-section">
      ...
      >
        ...
        <div className="section-header">
          ...
          <p className="section-label"> اسلیوها </p>
        </div>
...
export default InteractiveCardsSection5;
